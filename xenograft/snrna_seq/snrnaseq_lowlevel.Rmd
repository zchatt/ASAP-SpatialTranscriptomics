...
#Set a gene list of interest
my_genes <- c("GRCh38--SLC6A3","GRCh38--TH","GRCh38--KCNJ6")

# Select the RNA counts slot to be the default assay
DefaultAssay(merge.combined.sct) <- "RNA"

#Violin plot of markers of interest
p1 <- VlnPlot(merge.combined.sct, features=my_genes)
arrange <- ggarrange(plotlist=list(p1), nrow=2, ncol=2, widths = c(2,2))
ggsave("topgenes_deg_cl0.1.png", arrange)
