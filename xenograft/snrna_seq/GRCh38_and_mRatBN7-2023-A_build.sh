...
rat_fasta_url="ftp://ftp.ensembl.org/pub/release-110/fasta/rattus_norvegicus/cdna/Rattus_norvegicus.mRatBN7.2.cdna.all.fa.gz"
rat_fasta_in="${source}/Rattus_norvegicus.mRatBN7.2.cdna.all.fa"
...
cellranger mkref --ref-version="$version" \
    ...
    --genome="$rat_genome" --fasta="$rat_fasta_modified" --genes="$rat_gtf_filtered"